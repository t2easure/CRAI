...
const DUMMY_REPORTS: Report[] = [
  ...
  },
  {
    ...
    period_start: '2026-04-21',
    period_end: '2026-04-28',
    summary: '리니지2 커뮤니티는 이번 주 통/버그 관련 신고 게시글이 증가하였습니다.',
    category_filter: '총 31건 수집, 제거 없음, 유효 31건',
    category_translation: '영어 게시글 3건 번역 완료',
    category_classification: '통/버그 이슈 50% · 일반 30% · 사례 20%',
    category_analysis: '특정 던전 내 이슈 집중 신고. 이전 버전 귀환 요구 사례 활성.',
    full_report: '## 리니지2 주간 트렌드 리포트\n\n...',
    keywords: ['버그', '통', '신고', '이슈', '던전'],
    trend_level: 'hot',
    post_count: 31,
  },
]
